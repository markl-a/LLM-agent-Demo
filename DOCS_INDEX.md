...
| 框架 | 難度 | 適用場景 |
|------|------|----------|
| [Gradio](72.Gradio/) | ⭐ | 快速 UI 原型 |
| [Chainlit](71.Chainlit/) | ⭐⭐ | 聊天界面構建 |

### 🟠 工作流與狀態
| 框架 | 難度 | 適用場景 |
|------|------|----------|
| [Burr](76.Burr/) | ⭐⭐ | 狀態機管理 |
| [Marvin](74.Marvin/) | ⭐⭐ | AI 工程工具 |
| [Mirascope](75.Mirascope/) | ⭐⭐ | LLM 工作流 |

### 🔵 向量數據庫與檢索
| 框架 | 難度 | 適用場景 |
|------|------|----------|
| [Txtai](78.Txtai/) | ⭐⭐ | 語義搜索引擎 |
| [LanceDB](79.LanceDB/) | ⭐⭐ | 向量數據庫 |
| [Weaviate](80.Weaviate/) | ⭐⭐⭐ | 企業級向量庫 |

### 🟢 多 Agent 框架
| 框架 | 難度 | 適用場景 |
|------|------|----------|
| [Langroid](77.Langroid/) | ⭐⭐⭐ | 多 Agent 協作 |
